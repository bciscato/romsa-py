...
Before installing ROMSA, you need **Python** and **Git** installed on your computer.

### 🪟 Windows

1. **Python:** Download the "Windows installer (64-bit)" from [python.org](https://www.python.org/downloads/).
  
  - *Crucial:* When installing, check the box **"Add Python to PATH"**.
2. **Git:** Download and install from [git-scm.com](https://git-scm.com/download/win).
  

### 🍎 macOS

1. **Python:** Download the "macOS 64-bit universal2 installer" from [python.org](https://www.python.org/downloads/macos/).
  
2. **Git:** Open your Terminal and type `git`. If it's not installed, macOS will prompt you to install it automatically.
  

### 🐧 Linux

If you are on Linux, you likely know the drill, but here are the commands for Debian/Ubuntu systems:
